...
export default function Create({ user }) {
    ...
    return (
      ...
      <form action="/api/leagues/createLeague" method="POST"> 
        {/* Input box for name */}
        <input type='text' className={styles.createInput} name='name' placeholder='Name' /> 
        ...
        <div className='buttonHolder'> 
            ...
            <input type="submit" className={styles.createBtn} name='create' value="Create League"/> 
        </div>
    </form>
      </div>
    )
